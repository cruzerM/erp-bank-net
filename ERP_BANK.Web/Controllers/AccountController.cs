...
namespace ERP_BANK.Web.Controllers
{
    ...
    {
        LogInService.AccountServiceService logInService = new LogInService.AccountServiceService();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            bool s;
            bool d;
            //logInService.SignIn(model.Username, model.Password, out s, out d);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Username, Email = "mahmoud.amri@esprit.tnnn" };
        ...
        public ActionResult LogOff()
        {
            ...
            logInService.SignOut(User.Identity.GetUserName(), out s, out d);
